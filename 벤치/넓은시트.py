...
돌린 뒤 (v2) — 둘 다 맞음: 대조 0.962 -> 0.962 (같은 1순위 · 같은 챔퍼). 잘린 4장 중앙 0.426 -> 0.447.
  상자 0.272 -> 0.306 · 종 0.495 -> 0.552 (1순위 층 타원 -> 혼합) · 메카 0.357 -> 0.342 · Evil 0.574 -> 0.571.
  메카 · Evil 은 잘린 게 주 원인이 아니다(앞뒤로 긴 부품 · 넓은 소매).
"""
import json
import os
import sys
