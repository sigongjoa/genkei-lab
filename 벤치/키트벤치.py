...
Q8 틀에서 빠짐(다보 전) · Q9 조립 (09-23, README 「다음」 3 · 4). exe 를 다시 굽고 46장. 돌리기 전 기대:
  E1 Q8 — 사람형 35장 중 34 통과(robot_ejDr8 왼팔만 · 벤치/빠짐.py 와 같은 값) · 도형 11 모두 통과
  E2 Q9 — 끼우다 막히는 부품이 있는 장 <= 3 (다보 방향 = 경계에 수직이라 거의 안 막힌다)
  E3 나머지(Q1~Q7 · 부피비 · 사람형 중앙 0.744 · 해시)는 그대로
  돌린 뒤 (09-23, 46장): E1 ○ Q8 45/46 (robot_ejDr8 만) · E3 ○ 그대로 · **E2 ✗ Q9 34/46 — 12 장이 막힌다**.
  진짜 막힘(겹침 > 50 mm³)이 대부분: 치마 = 팔이 치마 속이라 아래서 끼우면 치마에 걸린다(2910 mm³) · 다리벌림 · knight =
  비스듬한 다리가 가는 길에 몸통을 친다(1500~1650 mm³). 원형사라면 치마를 떼 팔 · 다리를 먼저 끼우고 치마를 씌운다 — 겹이 없어서다.
  몇은 스침(1~4 mm³ · 공차 경계) — 문턱 1 mm³ 는 결과를 보고 안 바꾼다.
